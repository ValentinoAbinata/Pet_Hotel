...
<head>
  ...
  <style>
    ...
    .sidebar { min-width: 200px; max-width: 220px; height: 100vh; position: fixed; top: 56px; left: 0; padding: 1rem; background:#f8f9fa; }
    .content { margin-left: 240px; padding: 1.25rem; }
  </style>
</head>
<body>
      ...
      <?php if ($u && ($u['peran'] === 'customer')): ?>
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><?=htmlspecialchars($u['nama_lengkap'])?></a>
