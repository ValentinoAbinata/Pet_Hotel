...
(7, 'Ruang Vaksinasi', 'Vaksin Panleukopenia', 'Vaksinasi panleukopenia untuk anjing/kucing', 50000),
(8, 'Ruang Vaksinasi', 'Vaksin Rabies', 'Vaksinasi rabies untuk anjing/kucing', 150000),
(9, 'Ruang Vaksinasi', 'Vaksin Distemper', 'Vaksinasi distemper untuk anjing', 175000)
;
...
CREATE TABLE `monitoring_harian` (
  ...
  `aktual_mandi` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `peran` enum('customer','admin','dokter') NOT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `layanan`
  MODIFY `layanan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
